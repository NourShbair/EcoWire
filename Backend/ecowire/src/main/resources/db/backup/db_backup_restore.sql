-- =============================================================
-- EcoWire Database – Full Backup & Restore Script
-- Generated: 2024-06-20
--
-- HOW TO USE
-- ----------
-- BACKUP  : pg_dump -U <user> -d <dbname> -f ecowire_backup.sql
-- RESTORE : psql  -U <user> -d <dbname> -f db_backup_restore.sql
--
-- This script drops all existing data and re-creates the full
-- schema + seed data from scratch. Safe to run repeatedly.
-- =============================================================

-- ─────────────────────────────────────────────
-- 1. CLEAN SLATE  (order matters – child first)
-- ─────────────────────────────────────────────

DROP TABLE IF EXISTS eco_scores        CASCADE;
DROP TABLE IF EXISTS auto_policies     CASCADE;
DROP TABLE IF EXISTS home_policies     CASCADE;
DROP TABLE IF EXISTS property_policies CASCADE;
DROP TABLE IF EXISTS policies          CASCADE;

-- Also drop Flyway history so migrations re-run cleanly (optional)
-- DROP TABLE IF EXISTS flyway_schema_history;

-- ─────────────────────────────────────────────
-- 2. SCHEMA  (mirrors V1__initial_schema.sql)
-- ─────────────────────────────────────────────
...
-- ─────────────────────────────────────────────
-- 3. SEED DATA  (mirrors V2__seed_data.sql)
-- ─────────────────────────────────────────────
