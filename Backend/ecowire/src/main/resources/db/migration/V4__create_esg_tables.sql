-- =============================================================
-- V4__create_esg_tables.sql
-- Creates ESG extension tables for Sprint 2
-- carbon_emissions, climate_risk, nature_data, esg_metrics
-- =============================================================

-- Carbon emissions (Scope 1, 2, 3) per policy
...
-- Climate risk indicators per policy location
...
-- Nature data — water, soil, biodiversity (PROPERTY policies only)
...
-- ESG metrics — energy, renewables, workforce diversity
