...
public interface PolicyRepository extends JpaRepository<Policy, String> {
    ...
    long countByOrganizationIdAndPolicyType(String organizationId, PolicyType policyType);
    long countByPolicyTypeAndOrganizationIdIsNull(PolicyType policyType);
}
